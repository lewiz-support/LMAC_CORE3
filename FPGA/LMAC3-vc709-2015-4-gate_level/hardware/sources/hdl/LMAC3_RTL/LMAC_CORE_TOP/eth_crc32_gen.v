...
module eth_crc32_gen(
 ...
 always @(posedge clk) begin
 	if (!rst_n) begin
		...
		data_be_dly		<=	data_be;
		data_eop_dly1	<=	data_eop_dly;
		data_be_dly1	<=	data_be_dly;
		data_sop_dly	<=	data_sop;
 ...
 always @(*) begin
 	crc_in		=	(data_sop_dly & (cntr_speed == 2'b0))?	32'hFFFF_FFFF	:
 						(cntr_speed == 2'b0)? crc_out_d256	:
 						crc_in;
 end
