...
#
# Generated by export_simulation on Wed Jan 18 10:19:25 -0800 2017
#
################################################################################
...
./br_pre_data_fifo_ip_1024x256.sh
...
switch to the './br_pre_data_fifo_ip_1024x256.sh' script.

./br_pre_data_fifo_ip_1024x256.sh -reset_run
...
./br_pre_data_fifo_ip_1024x256.sh -noclean_files

For more information on the script, please type './br_pre_data_fifo_ip_1024x256.sh -help'.
