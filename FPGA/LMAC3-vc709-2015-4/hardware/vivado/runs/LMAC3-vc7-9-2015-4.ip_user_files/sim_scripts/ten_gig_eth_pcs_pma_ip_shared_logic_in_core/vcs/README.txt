...
#
# Generated by export_simulation on Wed Jan 18 10:06:32 -0800 2017
#
################################################################################
...
./ten_gig_eth_pcs_pma_ip_shared_logic_in_core.sh
...
switch to the './ten_gig_eth_pcs_pma_ip_shared_logic_in_core.sh' script.

./ten_gig_eth_pcs_pma_ip_shared_logic_in_core.sh -reset_run
...
./ten_gig_eth_pcs_pma_ip_shared_logic_in_core.sh -noclean_files

For more information on the script, please type './ten_gig_eth_pcs_pma_ip_shared_logic_in_core.sh -help'.
