...
# executing this script. Please type 'txfifo_ip_1024x256.sh -help' for more information.
#
...
reset_run()
{
  files_to_remove=(ucli.key txfifo_ip_1024x256_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log 64 AN.DB csrc txfifo_ip_1024x256_simv.daidir)
...
compile()
{
  ...
  vhdlan -work xil_defaultlib $opts_vhd \
    "$ref_dir/../../../../LMAC3-vc7-9-2015-4.srcs/sources_1/ip/txfifo_ip_1024x256/sim/txfifo_ip_1024x256.vhd" \
  2>&1 | tee -a vhdlan.log
...
elaborate()
{
  ...
  vcs $opts xil_defaultlib.txfifo_ip_1024x256 -o txfifo_ip_1024x256_simv
}
...
simulate()
{
  ...
  ./txfifo_ip_1024x256_simv $opts -do simulate.do
}
# Script usage
usage()
{
