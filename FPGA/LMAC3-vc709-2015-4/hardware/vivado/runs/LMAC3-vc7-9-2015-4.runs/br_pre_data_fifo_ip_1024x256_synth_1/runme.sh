...
HD_PWD='C:/SUNNY2/LMAC3-vc709-2015-4/hardware/LMAC3-vc7-9-2015-4/LMAC3-vc7-9-2015-4.runs/br_pre_data_fifo_ip_1024x256_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log br_pre_data_fifo_ip_1024x256.vds -m64 -mode batch -messageDb vivado.pb -notrace -source br_pre_data_fifo_ip_1024x256.tcl
