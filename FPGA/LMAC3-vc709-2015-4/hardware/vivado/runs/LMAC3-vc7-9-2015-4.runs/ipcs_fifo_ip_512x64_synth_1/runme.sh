...
HD_PWD='C:/SUNNY2/LMAC3-vc709-2015-4/hardware/LMAC3-vc7-9-2015-4/LMAC3-vc7-9-2015-4.runs/ipcs_fifo_ip_512x64_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ipcs_fifo_ip_512x64.vds -m64 -mode batch -messageDb vivado.pb -notrace -source ipcs_fifo_ip_512x64.tcl
