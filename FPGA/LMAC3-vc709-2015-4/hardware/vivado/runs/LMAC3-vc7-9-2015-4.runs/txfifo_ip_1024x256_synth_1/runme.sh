...
HD_PWD='C:/SUNNY2/LMAC3-vc709-2015-4/hardware/LMAC3-vc7-9-2015-4/LMAC3-vc7-9-2015-4.runs/txfifo_ip_1024x256_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log txfifo_ip_1024x256.vds -m64 -mode batch -messageDb vivado.pb -notrace -source txfifo_ip_1024x256.tcl
