...
HD_PWD='C:/SUNNY2/LMAC3-vc709-2015-4/hardware/LMAC3-vc7-9-2015-4/LMAC3-vc7-9-2015-4.runs/x2c_bcnt_fifo_ip_256x32_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log x2c_bcnt_fifo_ip_256x32.vds -m64 -mode batch -messageDb vivado.pb -notrace -source x2c_bcnt_fifo_ip_256x32.tcl
