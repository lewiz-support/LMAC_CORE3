...
This test consists of 4 packets with variable lengths. 
...
100G
 ...
 4 Frames Transmitted:

 1)  MAC address: Unicast, Packet Type: Normal IP.
     Packet length = 327 Bytes
     No. of valid Bytes in last Quadword = 07
     
 2)  MAC address: Unicast, Packet Type: Normal IP.
     Packet Length = 560 Bytes.
     No. of valid Bytes in last Quadword = 16

 3)  MAC address: Unicast, Packet Type: Normal IP.
     Packet Length = 594 Bytes
     No. of valid Bytes in last quadword = 18.
     
 4)  MAC address: Unicast, Packet Type: Normal IP.
     Packet Length = 352 Bytes
     No. of valid Bytes in last quadword = 32.
